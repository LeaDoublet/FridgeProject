        ...
        <v-card>
            ...
            <v-card-text>
                <v-container>
                    <v-row>
                        <v-col cols="12">
                            <v-text-field v-model="internalProduct.id" label="Id du produit" outlined readonly />
                        </v-col>
                        <v-col cols="12">
                            <v-text-field v-model="internalProduct.nom" label="Nom du produit" outlined readonly />
                        </v-col>
                        <v-col cols="12">
            ...
            <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="pink" text @click="close">Fermer</v-btn>
            </v-card-actions>
        </v-card>
    </v-dialog>
</template>
